...
# Desktop execution client (routes to user's desktop via Pool Manager)
from .desktop_execution_client import (
    DesktopExecutionClient,
    get_desktop_client,
    close_desktop_client,
)

# Model client (dual-mode: service/direct)
from .model_client import (
    ModelClient,
    ModelConfig,
    ModelMode,
    get_model_client,
    get_direct_model_client,
)
